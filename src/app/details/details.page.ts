...
export class DetailsPage implements OnInit {
  ...
  getData(){
    ...
    this.validations_form = this.formBuilder.group({
      identificationType: new FormControl(this.item.identificationType, Validators.required),
      identificationNumber: new FormControl(this.item.identificationNumber, Validators.required),
      ...
      diagnostic: new FormControl(this.item.diagnostic, Validators.required)
    });
  }
